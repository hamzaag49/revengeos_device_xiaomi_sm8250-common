...
constexpr const char kControlPath[] = "/sys/devices/virtual/touch/touch_dev/bump_sample_rate";

HighTouchPollingRate::HighTouchPollingRate() {
    mSupportsHighPollingRate = !access(kControlPath, F_OK);
}
...
Return<bool> HighTouchPollingRate::isEnabled() {
    ...
    if (!mSupportsHighPollingRate) return false;
